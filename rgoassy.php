        ...
        <div class="col-lg-12">
          <div class="row">
            <div class="col-md-12 ftco-animate">
              <h2 class="mb-4">Goassy Room</h2>
              <div class="single-slider owl-carousel">
                <div class="item">
                  <div class="room-img" style="background-image: url(images/g1.jpg);"></div>
                </div>
                <div class="item">
                  <div class="room-img" style="background-image: url(images/g2.jpg);"></div>
                </div>
                <div class="item">
                  <div class="room-img" style="background-image: url(images/g3.png);"></div>
                </div>
              </div>
            </div>
            <div class="col-md-12 room-single mt-4 mb-5 ftco-animate">
              ...
              <div class="d-md-flex mt-5 mb-5">
                <ul class="list">
                  ...
                  <li><span>Size:</span> 55 m2</li>
                </ul>
                <ul class="list ml-md-5">
                  <li><span>View:</span> Hill & Sea View</li>
